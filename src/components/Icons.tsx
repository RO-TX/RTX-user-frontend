 ...
 *
 * Not part of the stroked set above and deliberately so: brand marks have to
 * be reproduced as issued, which means its own viewBox, explicit fills, and
 * `stroke:none` so the icon styling elsewhere cannot recolour it.
 */
export const GoogleMark = (p: P) => (
  <svg viewBox="0 0 18 18" aria-hidden="true" fill="none" stroke="none" {...p}>
    <path
      fill="#4285F4"
